...
<ul>
  ...
  <li>Filipova, M. (2023). <em>Learning Vue.js: Build progressive user interfaces and single-page applications</em>. Packt Publishing.</li>
  ...
  <li>Price, M. J. (2023). <em>C# 12 and .NET 8 - Modern Cross-Platform Development Fundamentals</em> (8th ed.). Packt Publishing.</li>
  
  <li>Project Management Institute [PMI]. (2021). <em>A Guide to the Project Management Body of Knowledge (PMBOK Guide)</em> (7th ed.). Project Management Institute.</li>
